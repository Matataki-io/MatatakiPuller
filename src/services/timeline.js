...
class TimelineService {
  ...
  static async getMatatakiPost (userId, postIds) {
    ...
    const sql = `
      SELECT
        a.id, a.uid, a.author, a.title, a.status, a.hash, a.create_time, a.cover, a.require_holdtokens, a.require_buy, a.short_content, a.short_content_share, a.is_recommend, a.channel_id,
